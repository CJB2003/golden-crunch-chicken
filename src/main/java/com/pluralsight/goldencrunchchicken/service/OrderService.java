package com.pluralsight.goldencrunchchicken.service;

import com.pluralsight.goldencrunchchicken.model.*;
import com.pluralsight.goldencrunchchicken.model.*;
import com.pluralsight.goldencrunchchicken.model.enums.OrderStatus;
import com.pluralsight.goldencrunchchicken.util.ReceiptWriter;
...
public class OrderService {
    ...
    public Receipt checkout(Long id) {
        ...
        if (order.getChickenItems().isEmpty() && order.getDrinks().isEmpty() && order.getSides().isEmpty()) {
            ...
            System.out.println(TextFormatter.bold(TextFormatter.red("You need to have at least a drink or side in your order.")));
            return null;
        }
